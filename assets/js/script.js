...
(function (window, document, $, undefined) {
    ...
    window.handler.prototype = {
        ...
        onReadySetup : function() {
            ...
            $('form').find('[required]:not(input[type="email"], input[name="contrasena_2"], .number-card-validation)').on('blur keyup change', function(event){
                self.validateForms(event);
            });
            
             $('form').find('[data-add]').on('blur keyup change', function(event){
                self.validateForms(event);
            });
            
            $('form').find('input[type="email"]').on('blur', function(event){
               self.validateForms(event);
            });
            
            $('form').find('.passwd2-validation').on('blur', function(event){
               self.validateForms(event);
            });
            
            $('form').find('.number-card-validation').on('blur', function(event){
               self.validateForms(event);
            });
        ...
        onLoadSetup : function(){
            ...
            $('.triangle-foot').css('border-right-width' , $('.main-foot').width()/2);
            $('.triangle-foot').css('border-left-width' , $('.main-foot').width()/2);
